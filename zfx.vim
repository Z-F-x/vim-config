...
let s:base03 = '#3C3C3C' 
let s:base04 = '#808080' 
let s:base05 = '#D4D4D4' " Default text
let s:base06 = '#5c6370' " Comments
let s:base07 = '#FFFFFF' " Brightened text
let s:base08 = '#F44747' " Variables 
let s:base09 = '#B5CEA8' " Constants
let s:base0A = '#D7BA7D' " Functions
let s:base0B = '#6A9955' " Strings
let s:base0C = '#569CD6' " Preprocessor Directives
...
highlight CursorLine guifg=NONE guibg=#505050 ctermfg=NONE ctermbg=none gui=bold cterm=bold
